 ...
 * Author: eduardo
 *
 * Created on 11 de diciembre de 2018, 10:48
 */
...
/* Imprime en el flujo pf los datos de un grafo, devolviendo el número de caracteres impresos.
 * Comprueba si ha habido errorres en el flujo de salida. Si es así imprime mensaje 
 * de error en stderror y devuelve el valor -1.
 * El formato a seguir es: imprimir una linea por nodo con la información asociada al nodo y 
 * los id de sus conexiones. La salida para el grafo del ejercicio 2.3 de la parte 1 es:
 * [1, a, 2]  2 3 
 * [2, b, 2] 1 3 
 * [3, c, 2]] 1 2  */
