...
/* Types of function pointers supported by the queue. Note: they could be in elem_functions.h and include it here */ typedef void (*destroy_element_function_type)(void*);
